...
const jsxTextStory = (
  <TabText>
    <NekoTypo p style={{ lineHeight: "1.5", margin: "0 0 15px 0" }}>
      Hi! ☀️ Meow Apps isn't your typical plugin suite—it's a passion project
      led by me,{" "}
      <a target="_blank" href="https://jordymeow.com">
        Jordy Meow
      </a>
      , and a stellar team! 💕 Based in{" "}
      <a target="_blank" href="https://offbeatjapan.org">
        Japan
      </a>
      , we're all about making your WordPress experience smoother and speedier.
      Our plugins are all about boosting your site's performance and
      user-friendliness. Ready to level up your WordPress game? Check out{" "}
      <a href="http://meowapps.com" target="_blank">
        Meow Apps
      </a>{" "}
...
const jsxTextPerformance = (
  <TabText>
    <NekoTypo p>
      The <b>Empty Request Time</b> measures your installation's basic
      performance by showing the average time needed to process an empty request
      on your server. To see how disabling plugins affects the results, turn
      some off and run the test again. Aim for a time under 2,000 ms, but
      ideally, keep it below 500 ms. The <b>File Operation Time</b> creates a
      temporary 10MB file each time it runs. <b>The SQL Request Time</b>{" "}
      calculates the total number of posts. This process should be quick and
      have a similar duration to the Empty Request Time.
    </NekoTypo>
  </TabText>
);
...
const jsxTextRecommendations = (
  <TabText>
    <NekoTypo p>
      Maintain a streamlined WordPress setup by using essential plugins and a
      dependable hosting provider. Refrain from self-hosting unless you're an
      expert. Go further by reading our tutorials:
      <ul>
        <li>
          ⭐️{" "}
          <a
    ...
    <NekoSettings title="Main Menu">
      <NekoCheckboxGroup max="1">
        <NekoCheckbox
          ...
          description={
            <NekoTypo p>
              This will hide the Meow Apps Menu (on the left side) and
              everything it contains. You can re-enable it through though an
              option that will be added in Settings &rarr; General.
            </NekoTypo>
          }
          value="1"
          disabled={busy}
    ...
    <NekoSettings title="SSL Verify">
      <NekoCheckboxGroup max="1">
        <NekoCheckbox
          ...
          description={
            <NekoTypo p>
              This will enforce the usage of SSL when checking the license or
              updating the plugin.
            </NekoTypo>
          }
          value="1"
          ...
          <NekoTabs keepTabOnReload={true}>
                ...
                <NekoColumn minimal>
                  <StyledPluginBlock title="AI Engine" className="primary">
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        This is the ultimate AI plugin for WordPress. From a
                        chatbot adapted to your needs to an AI that can write
                        your content for you, API, REST, and more.
                      </p>
                      <p>
                        <div>
                          Free Version:{" "}
                  ...
                  <StyledPluginBlock title="Media Cleaner" className="primary">
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Is your Media Library bloated, your database heavy, and
                        your website running slow? Media Cleaner will clean your
                        Media Library from the media entries (and files) which
                        aren't used in your website, as well as broken entries.
                      </p>
                      <p>
                        <div>
                          Free Version:{" "}
                  ...
                  >
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Not only does Database Cleaner have a user-friendly UI,
                        but it's also equipped to handle large DBs, giving it an
                        edge over other plugins. It's a must-have for any
                        WordPress site.
                      </p>
                      <p>
                        <div>
                  ...
                  >
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Rename and move files directly from the dashboard,
                        manually, automatically or via AI, either individually
                        or in bulk. It's the best way to rename your files.
                      </p>
                      <p>
                        <div>
                          Free Version:{" "}
                  ...
                  <StyledPluginBlock title="Social Engine" className="primary">
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Effortlessly schedule and automate the perfect posts for
                        all your networks. Unlimited capabilities and infinite
                        className="plugin-actual-desc" extensibility, for free!
                      </p>
                      <p>
                        <div>
                          Free Version:{" "}
                ...
                <NekoColumn minimal>
                  ...
                  >
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Optimize your content for SEO and for the AI world, with
                        AI assistants... while keeping everything simple and
                        fast, as it should be! ✌️
                      </p>
                      <p>
                        <div>
                          Free Version:{" "}
                  ...
                  <StyledPluginBlock title="Meow Gallery" className="primary">
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Fast and beautiful galleries with many layouts. Forget
                        the heavy and slow plugins, use the Meow Gallery for a
                        better experience! 💕
                      </p>
                      <p>
                        <div>
                  ...
                  >
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Manage, Optimize, Replace your images with Perfect
                        Images.
                      </p>
                      <p>
                        <div>
                  ...
                  <StyledPluginBlock title="Photo Engine" className="primary">
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Organize your photos in folders and collections.
                        Synchronize with Lightroom. Simplify and speed up your
                        workflow.
                      </p>
                      <p>
                        <div>
                  ...
                  >
                    ...
                    <div className="plugin-desc">
                      ...
                      <p className="plugin-actual-desc">
                        Need a very simple but straightforward contact form?
                        This is the one you need. It's fast, simple, and
                        efficient.
                      </p>
                      <p>
                        <div>
            ...
            <NekoTab title="PHP Error Logs">
              <TabText>
                ...
                <NekoTypo p>
                  If you don't see any errors, your host might not allow remote
                  access to PHP error logs. Contact them for assistance, or look
