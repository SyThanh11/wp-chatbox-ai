...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const chatbotContainers = document.querySelectorAll('.lgl-chatbot-container');
  processContainers(chatbotContainers, ChatbotSystem);

  const discussionsContainers = document.querySelectorAll('.lgl-discussions-container');
